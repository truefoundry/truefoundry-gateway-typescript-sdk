...
import { UpdateDraftSessionRequestAgentSpecMessagesItem } from "./UpdateDraftSessionRequestAgentSpecMessagesItem.js";

export const UpdateDraftSessionRequestAgentSpec: core.serialization.ObjectSchema<
    serializers.internal.agents.UpdateDraftSessionRequestAgentSpec.Raw,
    TrueFoundryGateway.internal.agents.UpdateDraftSessionRequestAgentSpec
> = core.serialization.object({
    model: AgentModelSpec,
    instructions: core.serialization.string().optional(),
    messages: core.serialization.list(UpdateDraftSessionRequestAgentSpecMessagesItem).optional(),
...
export declare namespace UpdateDraftSessionRequestAgentSpec {
    export interface Raw {
        model: AgentModelSpec.Raw;
        instructions?: string | null;
        messages?: UpdateDraftSessionRequestAgentSpecMessagesItem.Raw[] | null;
