...
export const TurnEventUsageInputTokensBreakdown: core.serialization.ObjectSchema<
    serializers.TurnEventUsageInputTokensBreakdown.Raw,
    TrueFoundryGateway.TurnEventUsageInputTokensBreakdown
...
export declare namespace TurnEventUsageInputTokensBreakdown {
